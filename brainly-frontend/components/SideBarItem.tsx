...
const SideBarItem: React.FC<ItemProps> = ({ imgUrl, name }) => {
  ...
  return (
    <div
      onClick={() => setItem(name.toLowerCase())}
      className="w-full border-b border-neutral-600 py-2 sm:p-2 flex gap-5 justify-center md:justify-start items-center cursor-pointer hover:bg-neutral-700"
    >
